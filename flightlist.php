            ...
            <div class="container-fluid">    
                ...
                <div  id="divtop">
                    <center>
                        <br> <br><br>
                            <div id="dmain"  > 
                               <center><img src="./images/shutterstock_2.jpg" width="180px" height="150px" ></center>
                                <br>
                                    <input type="text" id="u_id" name="pnr" class="form-control" style="width:300px; margin-left: 66px;" placeholder="YYYY-MM-DD"><br>
                                   <br>
                                    <input type="submit" id="u_sub" name="u_sub" value="Check Flights" class="toggle btn btn-primary" style="width:120px; height: 29px; margin-left: 70px ; background-color: maroon;"><br>
                             </div>
                     </div>
                    </div>
               </div>
