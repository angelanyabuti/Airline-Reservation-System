...
$con=mysqli_connect("localhost","root","","kenyaairwaysreservation");
...
<html>
    <head>
       ...
       <script src="bootstrap/jquery.min.js"></script>
        ...
        <link type="text/css" rel="stylesheet" href="css/style2.css"></link>
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------<br>
<center><h3>Airpot Authority of Kenya</h3></center>
<center><h2>Boarding Pass - Airline Reservation Slip</h2></center><h4><?php echo $booking_status;?></h4>
<br>
<br>
<br>
<br>
...
<center><img src='images/kq.jpg' class='img-thumbnail' width='600px' style='height:180px;'></center>
                   ...
                   <?php
                    ...
                    $result1 = mysqli_query($con,"SELECT * FROM passengers where ='".$_SESSION['user']."'");
                      ...
                      {                  
                        ...
                        echo "<center><img src='images/shuttestock_2.jpg' class='img-thumbnail' width='180px' style='height:180px;'></center>";
                        echo"<div>";
                      }
                   ?>
                        </td>
