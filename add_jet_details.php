...
<html>
	...
	<body>
		...
		<form action="add_jet_details_form_handler.php" method="post">
			...
			<table cellpadding="5">
				<tr>
					<td class="fix_table">Enter a valid Plane ID</td>
				</tr>
				<tr>
			...
			<table cellpadding="5">
				<tr>
					<td class="fix_table">Enter the Plane Type/Model</td>
				</tr>
				<tr>
			...
			<table cellpadding="5">
				<tr>
					<td class="fix_table">Enter the total capacity of the Plane</td>
				</tr>
				<tr>
