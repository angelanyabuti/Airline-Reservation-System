	...
	<body>
		...
		<form action="payment_details_form_handler.php" method="post">
			...
			//inserting data into the server
				...
				{	
					//retrieving data from flight details table for economy class
				...
				{
					//retrieving data from flight details table for business class
			...
			<table cellpadding="5" style='margin-left: 50px'>
				...
				<tr>
					<td class="fix_table"><i class="fa fa-mobile" aria-hidden="true"></i> Mpesa <input type="radio" name="payment_mode" value="credit card" checked></td>
					...
					<td class="fix_table"><i class="fa fa-desktop" aria-hidden="true"></i> Paypal <input type="radio" name="payment_mode" value="net banking"></td>
				</tr>
			</table>
			<br>
